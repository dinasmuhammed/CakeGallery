...
import { CakeIcon, Menu } from 'lucide-react';
    ...
    <header className="bg-white shadow-md">
      <div className="container mx-auto px-4 py-6 flex flex-col sm:flex-row items-center justify-between">
        ...
        <a
          ...
          className="bg-gradient-to-r from-pink-400 to-pink-600 text-white font-bold py-2 px-4 rounded-full hover:from-pink-500 hover:to-pink-700 transition duration-300 flex items-center"
        >
